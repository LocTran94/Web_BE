...
var PostService = /** @class */ (function () {
    function PostService() {
        ...
        // }
        this.getAllProvisionService = function () { return __awaiter(_this, void 0, void 0, function () {
            var sql, provisions;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        sql = "select *\n                   from provision";
                        return [4 /*yield*/, this.provisionRepository.query(sql)];
                    case 1:
                        provisions = _a.sent();
                        if (!provisions) {
                            return [2 /*return*/, 'No posts found'];
                        }
                        return [2 /*return*/, provisions];
                }
            });
        }); };
