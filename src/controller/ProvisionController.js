...
var ProvisionService_1 = require("../service/ProvisionService");
var ProvisionController = /** @class */ (function () {
    function ProvisionController() {
        var _this = this;
        this.getAllProvision = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var response, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.provisionServices.getAllProvisionService()];
                    case 1:
                        response = _a.sent();
